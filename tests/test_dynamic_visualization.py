...
def test_visualize_with_different_layouts(sample_adjacency_matrix, temp_output_dir):
    """
    Test that the visualize method works with different layout options.
    """
    layouts = ['spring', 'hierarchical']
    for layout in layouts:
        ...
        output_file = temp_output_dir / f"dynamic_network_{layout}.html"
        assert output_file.exists()
        assert output_file.is_file()
...
def test_visualize_with_custom_visualization_params(sample_adjacency_matrix, temp_output_dir):
    """
