...
class TestHierarchicalClustering(unittest.TestCase):
    ...
    def test_invalid_metric_with_ward_linkage(self):
        with self.assertRaises(ValueError, msg="The 'ward' linkage method only supports the 'euclidean' metric."):
    ...
    def test_invalid_metric_without_ward_linkage(self):
        with self.assertRaises(ValueError, msg="Unsupported affinity metric: invalid_metric"):
            HierarchicalClustering(
                adjacency_matrix=self.adjacency_matrix,
                linkage='complete',
